...
- If a chosen show lacks host, fallback greeting to "Hey <ShowName> team, I'm Adam."
...
5) If answer is explicit yes:
   - send each email (one by one) with:
     powershell -NoProfile -ExecutionPolicy Bypass -File "scripts/gws-personal-gmail.ps1" -Action send-test -To "<email>" -Subject "Guest for your show?" -Body "<body>"
